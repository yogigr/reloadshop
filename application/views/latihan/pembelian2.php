...
<form method="get" action="<?php echo site_url('latihan/index.php'); ?>">
	<table>
		<tr>
			<td><label>Kode Pembelian</label></td>
			<td><input type="text" name="kode_pembelian" value="<?php echo $item['kode_pembelian'] ?>"></td>
		</tr>
		<tr>
			<td><label>TGL Pembelian</label></td>
			<td><input type="text" id="tanggal_pembelian" name="tanggal_pembelian" value="<?php echo $item['tanggal_pembelian'] ?>"></td>
		</tr>
		<tr>
